...
import 'package:my_app/ui/screens/add_sangin.dart';
...
class _MyPageSanginState extends State<MyPageSangin> {
  ...
  final List<_Product> products = [
    _Product(
      name: '고당도 하우스 수박',
      img: 'assets/img/fruit/watermelon.jpg',
      soldPercent: 90,
      leftQty: 1,
      price: '3,500원',
      originPrice: '7,000원',
    ...
    _Product(
      name: '부사 사과',
      img: 'assets/img/fruit/apple.jpg',
      soldPercent: 90,
      leftQty: 1,
      price: '3,500원',
      originPrice: '7,000원',
    ...
    _Product(
      name: '당도최고 딸기',
      img: 'assets/img/fruit/strawberry.jpg',
      soldPercent: 90,
      leftQty: 1,
      price: '3,500원',
      originPrice: '7,000원',
    ...
    _Product(
      name: '꿀참외',
      img: 'assets/img/fruit/oriental_melon.jpg',
      soldPercent: 90,
      leftQty: 1,
      price: '3,500원',
      originPrice: '7,000원',
    ...
    _Product(
      name: '맛있는 멜론',
      img: 'assets/img/fruit/melon.png',
      soldPercent: 90,
      leftQty: 1,
      price: '3,500원',
      originPrice: '7,000원',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // 하단 네비게이터 4개 (디자인만 반영)
      bottomNavigationBar: const SanginBottomNav(current: SanginTab.orders),
    );
  }
}
        ...
        children: [
          Positioned.fill(
            child: ClipRRect(
              ...
              child: Image.network('assets/img/store/1.jpg', fit: BoxFit.cover),
            ),
          ),
          Positioned(
            left: 10,
